'''
# Analyzing sales data from a ticket office.
...
if the office made $15000 with the original discount age, and would make $18000 with 14 as the discount age, then the growth would be ((18000-15000)/15000)*100 = 20%
...
calculo = ((ingresos_despues - ingresos_antes)/ingresos_antes)*100
print(int(calculo))
